...
import closeIcon from "/icon-close-white.svg";
    ...
    <main>
      <div className="main-wrapper flex flex-col md:flex-row md:px-[200px] md:py-[100px] relative">
        ...
        <div className="description p-6 md:basis-1/2 md:py-[40px]">
          ...
          <div className="buttons-container flex flex-col md:flex-row mt-8 b">
            <div className="state w-[100%] bg-green flex justify-around md:justify-center items-center space-x-10 bg-lightGrayishBlue rounded-lg p-3 md:p-2 md:mr-4 md:w-[150px]">
              <button
                onClick={decrease}
                className="minus text-[24px] md:text-[20px] font-[700] text-white transition-all hover:opacity-50"
              >
                -
              </button>
              <p className="md:text-[14px] font-bold text-white">{amount}</p>
              <button
                onClick={() => setAmount(amount + 1)}
                className="plus text-[24px] md:text-[20px] font-[700] text-white transition-all hover:opacity-50"
              >
                +
              </button>
            </div>
            <button className="flex flex-row  justify-center items-center add-btn border-none bg-green rounded-lg text-white  font-[700] px-[50px] py-[18px] mt-4 md:mt-0 md:py-0 md:text-[14px] transition-all btn-shadow hover:opacity-50">
              <img
